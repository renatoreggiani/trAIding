...
class modelo_arima(AbstractModelo):
    ...
    def fit(self) -> None:
        ...
        arima_model = auto_arima(self.df, stationary=is_stat, start_p=0, start_d=0, start_q=0,
    ...
    def salva_modelo(self):
        ...
        jdata[self.ticker].update({"parametros": self.modelo.order + self.modelo.seasonal_order,
                                   "train_date": hoje})
